 ...
 * CreateAction.
 */
abstract class CreateActionAbstract extends StockActionAbstract
{
    ...
    public function __invoke(ServerRequestInterface $request, ResponseInterface $response, array $args): ResponseInterface
    {
        try {
            ...
            // descomentar si se necesita created_user_id, o borrar si no se utiliza
            ...
            $stockEntity = $this->service->create($dsn, $stockData);
