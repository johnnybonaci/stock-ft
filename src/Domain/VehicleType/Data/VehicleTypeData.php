...
namespace App\Domain\VehicleType\Data;

use Pilot\Component\Abstracts\AbstractEntity;

/**
 * Designed to represent an entity that allows to work with VehicleType Data.
 */
final class VehicleTypeData extends AbstractEntity
{
    private int $id;
