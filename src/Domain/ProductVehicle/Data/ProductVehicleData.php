...
namespace App\Domain\ProductVehicle\Data;

use Pilot\Component\Abstracts\AbstractEntity;

/**
 * Designed to represent an entity that allows to work with ProductVehicle Data.
 */
final class ProductVehicleData extends AbstractEntity
{
    private int $id;
